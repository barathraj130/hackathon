...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-bg-light overflow-x-hidden">
      ...
      {/* Hero Section */}
      <main className="relative z-10 max-w-7xl mx-auto pt-48 pb-32 px-10">
        <div className="grid lg:grid-cols-2 gap-20 items-center">
          <div className="animate-fade-in">
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-royal/5 border border-royal/10 rounded-full mb-8">
              ...
              <span className="text-[10px] font-extrabold text-royal uppercase tracking-widest">Global Hackathon Standard v4.0</span>
            </div>
            
            <h1 className="text-7xl font-black text-navy leading-[0.95] tracking-tighter mb-8">
              Intelligence <br/> 
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-royal to-teal">Driven Synthesis</span>
            </h1>
            
            <p className="text-lg text-slate-500 max-w-lg leading-relaxed mb-12">
              The first high-fidelity automation engine designed exclusively for rapid innovation cycles. 
              Transform architecture diagrams and technical logic into professional-grade artifacts instantly.
            </p>

            <div className="flex items-center gap-6">
              <button 
                onClick={() => router.push('/login')} 
                className="bg-navy text-white px-10 py-5 rounded-2xl font-black uppercase text-[11px] tracking-[0.3em] hover:scale-105 active:scale-95 transition-all shadow-2xl shadow-navy/30"
              >
                Start Processing
              </button>
              <div className="flex flex-col">
                <span className="text-2xl font-black text-navy leading-none">2.4k+</span>
                <span className="text-[10px] font-bold text-slate-400 uppercase tracking-widest mt-1">Artifacts Synthesized</span>
              </div>
            </div>
          </div>
