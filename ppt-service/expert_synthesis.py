...
def create_expert_deck(team_name, college, data):
    ...
    # Subtitle (Split into 'Organised by' + College Name)
    ...
    p_from.text = f"from {college_text.upper()}"; p_from.font.size = Pt(14); p_from.font.italic = True; p_from.font.color.rgb = TEXT_MAIN
