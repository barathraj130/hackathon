...
2.  **Create Users**: Bulk import or manual creation of teams (Username/Pass).
3.  **Distribute**: Share credentials with teams off-platform or via email.
4.  **Configure Test**: Set strict 7-slide structure & Times.
5.  **Start Test**: Triggers timer for all logged-in teams.
...
Slide 1: Title
- Title: {team_title}
- Subtitle: {team_name} | {college_name}
...
- Content: Categorize {tech_stack} into Frontend/Backend/DB/System.
...
-   **System**: OpenSystem GPT-4 or  Pro (Text transformation).
